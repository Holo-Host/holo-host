...
#[utoipa::path(
    ...
    tag = "Manifest",
    summary = "Delete manifiest",
    description = "Requires 'manifest.Delete' permission",
    security(
        ("Bearer" = [])
    ),
    responses(
...
pub async fn delete_manifest(
    ...
    let _ = match providers::crud::delete::<schemas::manifest::Manifest>(
        db.as_ref().clone(),
        schemas::manifest::MANIFEST_COLLECTION_NAME.to_string(),
        id.clone(),
    )

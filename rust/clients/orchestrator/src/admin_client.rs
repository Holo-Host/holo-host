...
pub async fn run(admin_creds_path: &Credentials, nats_url: String) -> anyhow::Result<JsClient> {
    log::info!("nats_url : {}", nats_url);
    log::info!("admin creds path : {:?}", admin_creds_path);
    ...
    let admin_client = JsClient::new(JsClientBuilder {
        ...
        credentials: Some(vec![admin_creds_path.clone()]),

...
use db_utils::schemas::job::{Job, JobState};
...
impl JobError {
    ...
    pub fn job_failed(msg: &str) -> Self {
...
pub type JobOpResult<T> = Result<T, JobError>;

#[derive(Default, Clone, Debug, Deserialize, Serialize)]
pub enum JobResponsePayload {
    #[default]
    None,
    HolochainDhtV1(Bson),
}

/// Status information for a deployed Job
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct JobStatus {
    /// Optional MongoDB ObjectId for the status
    #[serde(skip_serializing_if = "Option::is_none")]
    pub id: Option<ObjectId>,
    pub desired: JobState,
    pub actual: JobState,
    pub payload: JobResponsePayload,
}
...
impl EndpointTraits for JobApiResult {}
impl GetSubjectTags for JobApiResult {
    fn get_subject_tags(&self) -> HashMap<String, String> {
        self.maybe_response_tags.clone().unwrap_or_default()
    }
}
impl GetResponse for JobApiResult {
...
impl GetHeaderMap for JobApiResult {
